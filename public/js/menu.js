...
// Modifique a função adicionaProdutoAoCarrinhoLocal para evitar duplicatas
function adicionaProdutoAoCarrinhoLocal(productName) {
    ...
    if (!itensSelecionados.includes(productName)) {
...
// Importe ou implemente uma função debounce
...
// Use o debounce para evitar chamadas rápidas
...
}, 1)); // Ajuste o tempo de acordo com suas necessidades
});
